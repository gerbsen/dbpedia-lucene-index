...
public class DBpediaLuceneIndexGenerator {
	...
	public static void main(String[] args) throws CorruptIndexException, IOException, InterruptedException {
		System.out.println(UrlEscapers.urlFragmentEscaper().escape("http://dbpedia.org/resource/Miłkowice,_Greater_Poland_Voivodeship"));
		...
		while ( surfaceFormIterator.hasNext() ) {
			...
			String uri = UrlEscapers.urlFragmentEscaper().escape(DBPEDIA_NAMESPACE + fragment);
			try {
...
//				System.out.println("Operation took " + (endTime - startTime) + "ms");
			...
			{System.out.println("Waiting for 1 second"+e.getMessage());Thread.sleep(1000);}
